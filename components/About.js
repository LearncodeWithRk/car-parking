    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid items-center grid-cols-1 gap-y-8 lg:grid-cols-2 gap-x-16 xl:gap-x-24">
            <div class="relative mb-12">
                <img class="w-full rounded-md" src="https://res.cloudinary.com/learncodewithrk/image/upload/v1685267606/carparking%20website/parking23_b1e0uu.png" alt="" />
                    ...
                    <div class="overflow-hidden bg-white rounded">
                        <div class="px-10 py-6">
                            <div class="flex items-center">
                                ...
                                <p class="pl-6 text-sm font-medium text-black sm:text-lg">On The Go  <br />with ParkMobile</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div>
                ...
                <h2 class="mt-10 text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl lg:leading-tight">On The Go with ParkMobile</h2>
                <p class="mt-6 text-lg leading-relaxed text-gray-600">Available in more than 400 cites across the U.S., ParkMobile gives you the ability to park.</p>
