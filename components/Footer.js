    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-y-12 gap-x-8 xl:gap-x-12">
            <div className="col-span-2 md:col-span-4 xl:pr-8">
                <Image className="w-auto h-9" src="https://res.cloudinary.com/learncodewithrk/image/upload/v1685268386/carparking%20website/logo_footer_lyik17.png" alt="" width={1920} height={1280}/>
            ...
            <div className="lg:col-span-2">
                ...
                <ul className="mt-6 space-y-5">
                    <li>
                        <Link href="#" title="" className="flex text-sm text-gray-800 transition-all duration-200 hover:text-orange-600 focus:text-orange-600"> About </Link>
                    </li>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <p className="text-sm text-gray-600">© Copyright 2021, All Rights Reserved by LearnCode With RK</p>
