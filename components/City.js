  ...
  return (
    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-600">ParkMobile is making parking easier in over 3,000 locations across all major cities in India.</p>
        </div>
                ...
                <div className="p-8">
                    <div className="flex items-center">
                        ...
                        <div className="ml-5 mr-auto">
                            <p className="text-xl font-semibold text-black">Delhi</p>
            ...
            <div className="overflow-hidden bg-white rounded shadow">
                <div className="p-8">
                    <div className="flex items-center">
                        <Image className="flex-shrink-0 w-12 h-auto" src="https://res.cloudinary.com/learncodewithrk/image/upload/v1685267179/carparking%20website/parking_ixmb77.png" alt="" width={1920} height={1280}/>
                        <div className="ml-5 mr-auto">
                            <p className="text-xl font-semibold text-black">Mumbai</p>
                            <p className="mt-px text-sm text-gray-600">Best Location</p>
                        </div>
            ...
            <div className="overflow-hidden bg-white rounded shadow">
                <div className="p-8">
                    <div className="flex items-center">
                        <Image className="flex-shrink-0 w-12 h-auto" src="https://res.cloudinary.com/learncodewithrk/image/upload/v1685267179/carparking%20website/parking_ixmb77.png" alt="" width={1920} height={1280}/>
                        <div className="ml-5 mr-auto">
                            <p className="text-xl font-semibold text-black">Bengaluru</p>
                            <p className="mt-px text-sm text-gray-600">Best Location</p>
                        </div>
                        <svg className="hidden w-5 h-5 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3" />
