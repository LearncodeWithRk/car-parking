        ...
        <div className="grid items-stretch gap-y-10 md:grid-cols-2 md:gap-x-20">
            <div className="relative grid grid-cols-2 gap-6 mt-10 md:mt-0">
                <div className="overflow-hidden aspect-w-3 aspect-h-4">
                    <Image className="object-cover object-top origin-top scale-150" src="https://res.cloudinary.com/learncodewithrk/image/upload/v1685266975/carparking%20website/parking_umaeij.png" alt="" width={1920} height={1280}/>
                </div>

                <div className="relative">
                    <div className="h-full overflow-hidden aspect-w-3 aspect-h-4">
                        <Image className="object-cover scale-150 lg:origin-bottom-right" src="https://res.cloudinary.com/learncodewithrk/image/upload/v1685266976/carparking%20website/parking1_h8v8sx.png" alt="" width={1920} height={1280}/>
                    </div>
                ...
                <div className="absolute -translate-x-1/2 left-1/2 -top-16">
                    <Image className="w-32 h-32" src="https://res.cloudinary.com/learncodewithrk/image/upload/v1685266974/carparking%20website/parking3_tko5uv.png" alt="" width={1920} height={1280}/>
                </div>
            </div>
