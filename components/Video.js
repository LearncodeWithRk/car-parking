        ...
        <div class="grid items-stretch gap-y-10 md:grid-cols-2 md:gap-x-20">
            <div class="relative grid grid-cols-2 gap-6 mt-10 md:mt-0">
                <div class="overflow-hidden aspect-w-3 aspect-h-4">
                    <img class="object-cover object-top origin-top scale-150" src="https://res.cloudinary.com/learncodewithrk/image/upload/v1685266975/carparking%20website/parking_umaeij.png" alt="" />
                </div>

                <div class="relative">
                    <div class="h-full overflow-hidden aspect-w-3 aspect-h-4">
                        <img class="object-cover scale-150 lg:origin-bottom-right" src="https://res.cloudinary.com/learncodewithrk/image/upload/v1685266976/carparking%20website/parking1_h8v8sx.png" alt="" />
                    </div>
                ...
                <div class="absolute -translate-x-1/2 left-1/2 -top-16">
                    <img class="w-32 h-32" src="https://res.cloudinary.com/learncodewithrk/image/upload/v1685266974/carparking%20website/parking3_tko5uv.png" alt="" />
                </div>
            </div>

            <div class="flex flex-col items-start xl:px-16">
                <h2 class="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">Easily Pay for Parking From Your Phone</h2>
                <p class="mt-4 text-base leading-relaxed text-gray-600">No change? Quickly pay for on-street parking right from your mobile device. Watch the video to learn how simple parking with ParkMobile can be..</p>
