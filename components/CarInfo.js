  ...
  return (
    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="max-w-lg mx-auto mt-4 text-base leading-relaxed text-gray-600">ParkMobile puts the power to park in your hands. Whether you are looking for a spot now or reserving a spot for later, ParkMobile has you covered.</p>
        </div>
